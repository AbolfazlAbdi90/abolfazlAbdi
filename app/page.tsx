    ...
    >
      ...
      >
        ...
        <div className="flex justify-center md:justify-start space-x-6 mt-6 text-black">
          ...
          >
            <svg className="w-8 h-8" viewBox="0 0 24 24" fill="currentColor">
              <path d="M20.52 3.48A11.88 11.88 0 0012 0C5.37 0 0 5.37 0 12c0 2.11.55 4.16 1.6 5.99L0 24l6.23-1.63A11.93 11.93 0 0012 24c6.63 0 12-5.37 12-12a11.88 11.88 0 00-3.48-8.52z" />
            </svg>
          </a>
